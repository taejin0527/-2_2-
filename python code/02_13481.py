...
data = pd.read_csv("/Users/taejin/Desktop/13481_stop.csv", names=['line_no', 'inout_type', 'seq', 'stop_name', 'x', 'y', 'get_date'])

data2 = pd.read_csv("/Users/taejin/Desktop/13481.csv", names=['get_date', 'lat', 'lng', 'speed', 'line_no'])
